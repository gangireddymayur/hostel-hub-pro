...
import { S as StatCard } from "./stat-card-Dmrq35Mq.mjs";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-CAUr8Ge9.mjs";
import { B as Badge } from "./badge-BtTda0Mk.mjs";
import { ResponsiveContainer, AreaChart, CartesianGrid, XAxis, YAxis, Tooltip, Area, BarChart, Legend, Bar } from "recharts";
import { b as getSuperAnalytics, g as getSuperHostels } from "./api-BWS4qRyW.mjs";
...
function SuperDashboard() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PageHeader, { title: "Platform overview", description: "Real-time view of hostels, students and leave activity across the network." }),
    /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2 xl:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsx(StatCard, { label: "Leave Requests", value: totalLeaves.toLocaleString(), icon: ClipboardList, tone: "warning", hint: "Across all hostels" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-6 grid gap-4 lg:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Leave activity" }) }),
