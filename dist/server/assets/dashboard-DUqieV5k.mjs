...
import { n as getHostelDashboard, o as getHostelStudents, k as getLeaveRequests } from "./api-xLViaJtq.mjs";
...
function AdminDashboard() {
  ...
  const outsideStudents = useMemo(() => leaves.filter((leave) => leave.gatePass?.status === "OUT").length, [leaves]);
