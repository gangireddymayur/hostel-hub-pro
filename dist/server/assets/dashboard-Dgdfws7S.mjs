...
import { P as PageHeader, A as Avatar, b as AvatarFallback } from "./dashboard-shell-wIEew92i.mjs";
import { S as StatCard } from "./stat-card-CwsJbBv0.mjs";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-DZDs0iFR.mjs";
import { B as Badge } from "./badge-D8XQG7Oz.mjs";
import { q as getHostelDashboard, t as getHostelStudents, n as getLeaveRequests, f as getHostels, B as Button } from "./api-awou-MCe.mjs";
...
function AdminDashboard() {
  ...
  const outsideLast24h = useMemo(() => {
    const now = /* @__PURE__ */ new Date();
    const past24h = new Date(now.getTime() - 24 * 60 * 60 * 1e3);
  ...
  const reviewedRequests = useMemo(() => {
    const list = filteredLeaves.filter((leave) => leave.final_status === "APPROVED" || leave.final_status === "REJECTED");
    let filtered = list;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 grid gap-6 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { className: "pb-3 border-b border-border/50", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between", children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-base font-semibold", children: "Students Outside (Last 24h)" }),
          /* @__PURE__ */ jsx("input", { type: "text", placeholder: "Search name/ID…", value: outsideSearch, onChange: (e) => setOutsideSearch(e.target.value), className: "h-8 w-44 rounded-md border border-input bg-background px-2.5 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-ring font-medium" })
        ] }) }),
        /* @__PURE__ */ jsx(CardContent, { className: "max-h-[350px] overflow-y-auto pt-4 space-y-4", children: outsideLast24h.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground py-8 text-center", children: "No students currently outside within last 24h." }) : outsideLast24h.map((leave) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-border/40 pb-3 last:border-0 last:pb-0", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { className: "pb-3 border-b border-border/50", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between", children: [
          ...
          /* @__PURE__ */ jsxs("select", { value: reviewedFilter, onChange: (e) => setReviewedFilter(e.target.value), className: "h-8 w-36 rounded-md border border-input bg-background px-2.5 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-ring font-medium", children: [
