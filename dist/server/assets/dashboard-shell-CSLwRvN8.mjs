...
import { X, PanelLeft, GraduationCap, LayoutDashboard, Building2, BarChart3, Settings, Users, FileSpreadsheet, BedDouble, UserCog, ShieldCheck, ClipboardList, MapPin, CheckCircle2, FileBarChart, LogOut, Moon, Sun, Search, Bell } from "lucide-react";
import { f as cn, B as Button, I as Input, p as logout } from "./api-HRN8onLj.mjs";
import * as SeparatorPrimitive from "@radix-ui/react-separator";
import * as SheetPrimitive from "@radix-ui/react-dialog";
import * as TooltipPrimitive from "@radix-ui/react-tooltip";
import { c as clearSession, a as getTheme, b as setTheme, i as initTheme, g as getSession } from "./router-MtHgmJSR.mjs";
  ...
  return /* @__PURE__ */ jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsx(SidebarHeader, { className: "border-b border-sidebar-border", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-2 py-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid flex-1 text-left text-sm leading-tight group-data-[collapsible=icon]:hidden", children: [
        /* @__PURE__ */ jsx("span", { className: "truncate font-semibold", children: "HostelOS" }),
