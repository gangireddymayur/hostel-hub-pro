...
import { X, PanelLeft, ShieldCheck, LayoutDashboard, Building2, BarChart3, Settings, ClipboardList, MapPin, CheckCircle2, Users, FileSpreadsheet, UserCog, FileBarChart, LogOut, Moon, Sun, Search, Bell } from "lucide-react";
import { c as cn, B as Button, I as Input, C as logout } from "./api-CwmPl7BH.mjs";
import * as SeparatorPrimitive from "@radix-ui/react-separator";
import * as SheetPrimitive from "@radix-ui/react-dialog";
import * as TooltipPrimitive from "@radix-ui/react-tooltip";
import { c as clearSession, a as getTheme, b as setTheme, i as initTheme, g as getSession } from "./router-BEauwGv0.mjs";
...
function AppSidebar({ role }) {
  ...
  return /* @__PURE__ */ jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsx(SidebarHeader, { className: "border-b border-sidebar-border", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-2 py-2", children: [
      /* @__PURE__ */ jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-primary-glow text-primary-foreground shadow", children: /* @__PURE__ */ jsx(ShieldCheck, { className: "h-5 w-5" }) }),
