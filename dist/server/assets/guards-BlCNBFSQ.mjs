...
import { h as uploadStaffPhoto, e as getHostelStaff, i as createStaff, j as updateStaff, B as Button, I as Input } from "./api-SYNT1tFU.mjs";
...
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, f as DialogFooter } from "./dialog-DXX--27X.mjs";
    ...
    /* @__PURE__ */ jsx(PageHeader, { title: "Security guards", description: "Manage security guards with Android app access.", action: /* @__PURE__ */ jsxs(Dialog, { open, onOpenChange: (val) => {
      ...
      /* @__PURE__ */ jsxs(DialogContent, { children: [
        ...
        /* @__PURE__ */ jsxs("form", { className: "grid gap-4", onSubmit: (event) => {
          ...
          /* @__PURE__ */ jsx(DialogFooter, { children: /* @__PURE__ */ jsx(Button, { type: "submit", children: editingGuard ? "Save changes" : "Save" }) })
