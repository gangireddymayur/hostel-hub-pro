...
import { P as PageHeader } from "./dashboard-shell-BwIVsizz.mjs";
import { g as getSuperHostels, a as createHostel, u as updateHostel, s as setHostelStatus, B as Button, I as Input } from "./api-xLViaJtq.mjs";
import { C as Card, a as CardContent } from "./card-DenU0qcm.mjs";
import { B as Badge } from "./badge-P8qOImNr.mjs";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-BhHC8lPC.mjs";
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-BNBHrFXX.mjs";
import { L as Label } from "./label-5jpj4Hj5.mjs";
    ...
    /* @__PURE__ */ jsx(PageHeader, { title: "Hostel management", description: "Create, edit and manage all hostels on the platform.", action: /* @__PURE__ */ jsxs(Dialog, { open, onOpenChange: setOpen, children: [
      ...
      /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-2xl", children: [
        /* @__PURE__ */ jsxs(DialogHeader, { children: [
          ...
          /* @__PURE__ */ jsx(DialogDescription, { children: "Provision a new hostel workspace. The hostel admin is created automatically with the same email and password." })
        ] }),
...
function HostelForm({
  ...
  return /* @__PURE__ */ jsxs("form", { className: "grid gap-4 md:grid-cols-2", onSubmit: (event) => {
    ...
    /* @__PURE__ */ jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsx(Field, { name: "password", label: "Password", type: "password", defaultValue: "", helper: "Used for both the hostel and its auto-created admin login." }) }),
