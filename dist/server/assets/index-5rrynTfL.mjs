...
import { o as getHostelStudents, f as getHostels, v as createStudent, w as updateStudent, x as deleteStudent, y as uploadStudentPhoto, z as uploadParentPhoto, B as Button, I as Input } from "./api-Bf0rDCn5.mjs";
...
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-DIs8k9iq.mjs";
import { L as Label } from "./label-D4VpiKic.mjs";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-Iaw4_0DH.mjs";
    ...
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "p-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-4 flex flex-wrap items-center gap-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative max-w-sm flex-1", children: [
          ...
          /* @__PURE__ */ jsx(Input, { placeholder: "Search by name, ID, room…", value: q, onChange: (e) => {
            setQ(e.target.value);
            setPage(1);
          }, className: "pl-9" })
        ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-lg border border-border/60 bg-card", children: /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: paginated.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 7, className: "text-center py-6 text-muted-foreground", children: "No student records found." }) }) : paginated.map((student) => /* @__PURE__ */ jsxs(TableRow, { children: [
