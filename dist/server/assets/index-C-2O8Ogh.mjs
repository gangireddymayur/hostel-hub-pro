...
import { P as PageHeader, A as Avatar, b as AvatarImage, a as AvatarFallback } from "./dashboard-shell-Cj8dwLf5.mjs";
import { o as getHostelStudents, e as getHostels, p as createStudent, q as updateStudent, t as uploadStudentPhoto, B as Button, I as Input } from "./api-BNuoB_CA.mjs";
import { C as Card, a as CardContent } from "./card-_oxZDB5M.mjs";
import { B as Badge } from "./badge--5BeoX6F.mjs";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-DqMxTIHy.mjs";
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-D5eD5alj.mjs";
import { L as Label } from "./label--6QkpCNR.mjs";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DsPMJc0r.mjs";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-2xl", children: [
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: (event) => {
          ...
          createMutation.mutate({
            ...
            hostel_id: selectedHostel || void 0
          });
          ...
          /* @__PURE__ */ jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "hostel_id", children: "Hostel (Optional)" }),
    ...
    /* @__PURE__ */ jsx(Dialog, { open: !!editingStudent, onOpenChange: (open2) => !open2 && setEditingStudent(null), children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-2xl", children: [
      ...
      editingStudent ? /* @__PURE__ */ jsxs("form", { onSubmit: (event) => {
        ...
        /* @__PURE__ */ jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsx(Field, { name: "parent_mobile", label: "Parent Mobile", defaultValue: editingStudent.parent_mobile, required: true }) }),
        /* @__PURE__ */ jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "hostel_id", children: "Hostel (Optional)" }),
          /* @__PURE__ */ jsxs(Select, { value: selectedHostel, onValueChange: setSelectedHostel, children: [
            /* @__PURE__ */ jsx(SelectTrigger, { id: "hostel_id", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select a hostel" }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "password", children: "Password (Optional)" }),
          /* @__PURE__ */ jsx(Input, { id: "password", name: "password", type: "password" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Leave blank to keep current password." })
        ] }),
        /* @__PURE__ */ jsxs(DialogFooter, { className: "md:col-span-2", children: [
