...
import { Plus, Trash2, Search, Eye, Pencil, KeyRound, AlertTriangle, Upload, EyeOff } from "lucide-react";
import { P as PageHeader } from "./dashboard-shell-DIa-7dcz.mjs";
import { r as getHostelStudents, f as getHostels, y as createStudent, z as updateStudent, A as deleteStudent, C as bulkDeleteStudents, D as uploadStudentPhoto, E as uploadParentPhoto, B as Button, I as Input } from "./api-BDk_J2ev.mjs";
import { C as Card, a as CardContent } from "./card-DlMLcUpm.mjs";
import { B as Badge } from "./badge-DUzQDhd2.mjs";
import { A as Avatar, a as AvatarImage, b as AvatarFallback } from "./avatar-BNZG9A8s.mjs";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-DPouow8N.mjs";
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-CEhvd1sn.mjs";
import { L as Label } from "./label-CCJKFdo-.mjs";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DhoO4aqx.mjs";
...
function StudentsPage() {
  ...
  const [activePasswordTab, setActivePasswordTab] = useState("STUDENT");
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: paginated.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 8, className: "text-center py-6 text-muted-foreground", children: "No student records found." }) }) : paginated.map((student) => {
          ...
          return /* @__PURE__ */ jsxs(TableRow, { className: isSelected ? "bg-primary/5 hover:bg-primary/10" : void 0, children: [
            ...
            /* @__PURE__ */ jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-1", children: [
              ...
              /* @__PURE__ */ jsx(Button, { size: "icon", variant: "ghost", className: "text-amber-500 hover:text-amber-600 hover:bg-amber-500/10", title: "Change passwords", onClick: () => {
    ...
    /* @__PURE__ */ jsx(Dialog, { open: !!editingStudent, onOpenChange: (open2) => !open2 && setEditingStudent(null), children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-2xl", children: [
      ...
      editingStudent ? /* @__PURE__ */ jsxs("form", { onSubmit: (event) => {
        ...
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 rounded-lg border border-border/70 bg-muted/30 p-3 text-xs text-muted-foreground flex items-center justify-between", children: [
          /* @__PURE__ */ jsx("span", { children: "🔐 Need to update student or parent login password?" }),
          /* @__PURE__ */ jsxs(Button, { type: "button", variant: "outline", size: "sm", className: "gap-1.5 text-xs text-amber-600 dark:text-amber-400 border-amber-500/30 hover:bg-amber-500/10", onClick: () => {
    ...
    /* @__PURE__ */ jsx(Dialog, { open: !!passwordStudent, onOpenChange: (isOpen) => !isOpen && setPasswordStudent(null), children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-md", children: [
      /* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-full bg-amber-500/15 text-amber-500", children: /* @__PURE__ */ jsx(KeyRound, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(DialogTitle, { className: "text-lg font-bold", children: "Manage Passwords" }),
          /* @__PURE__ */ jsx(DialogDescription, { className: "text-xs", children: passwordStudent ? `${passwordStudent.name} (${passwordStudent.student_id})` : "Reset login credentials" })
        ] })
      ] }) }),
      passwordStudent ? /* @__PURE__ */ jsxs("div", { className: "space-y-4 py-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex rounded-lg bg-muted p-1 text-xs font-semibold", children: [
          /* @__PURE__ */ jsx("button", { type: "button", onClick: () => {
            setActivePasswordTab("STUDENT");
            setNewPassword("");
          }, className: `flex-1 rounded-md py-1.5 transition-all ${activePasswordTab === "STUDENT" ? "bg-background text-foreground shadow-sm font-bold" : "text-muted-foreground hover:text-foreground"}`, children: "Student Password" }),
          /* @__PURE__ */ jsx("button", { type: "button", onClick: () => {
            setActivePasswordTab("PARENT");
            setNewPassword("");
          }, className: `flex-1 rounded-md py-1.5 transition-all ${activePasswordTab === "PARENT" ? "bg-background text-foreground shadow-sm font-bold" : "text-muted-foreground hover:text-foreground"}`, children: "Parent Password" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border/80 bg-muted/30 p-3 text-xs space-y-1", children: [
          /* @__PURE__ */ jsx("div", { className: "text-muted-foreground", children: activePasswordTab === "STUDENT" ? "Account Identifier:" : "Parent Mobile Number:" }),
          /* @__PURE__ */ jsx("div", { className: "font-mono font-semibold text-foreground", children: activePasswordTab === "STUDENT" ? `${passwordStudent.student_id} / ${passwordStudent.mobile}` : passwordStudent.parent_mobile })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "new_password_input", children: activePasswordTab === "STUDENT" ? "New Student Password" : "New Parent Password" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(Input, { id: "new_password_input", type: showPassword ? "text" : "password", placeholder: "Enter new password (min 4 characters)", value: newPassword, onChange: (e) => setNewPassword(e.target.value), className: "pr-10", autoFocus: true }),
            /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setShowPassword(!showPassword), className: "absolute right-3 top-2.5 text-muted-foreground hover:text-foreground", title: showPassword ? "Hide password" : "Show password", children: showPassword ? /* @__PURE__ */ jsx(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Eye, { className: "h-4 w-4" }) })
          ] }),
          newPassword.length > 0 && newPassword.length < 4 && /* @__PURE__ */ jsx("p", { className: "text-[11px] text-amber-500 font-medium", children: "Password must be at least 4 characters." })
        ] }),
        /* @__PURE__ */ jsxs(DialogFooter, { className: "pt-2 gap-2", children: [
          /* @__PURE__ */ jsx(Button, { type: "button", variant: "ghost", onClick: () => setPasswordStudent(null), children: "Cancel" }),
          /* @__PURE__ */ jsx(Button, { type: "button", disabled: newPassword.trim().length < 4 || updateMutation.isPending, className: "bg-primary text-primary-foreground font-semibold", onClick: () => {
            const payload = activePasswordTab === "STUDENT" ? {
              password: newPassword.trim()
            } : {
              parent_password: newPassword.trim()
            };
            updateMutation.mutate({
              studentId: passwordStudent.id,
              payload
            }, {
              onSuccess: () => {
                toast.success(`${activePasswordTab === "STUDENT" ? "Student" : "Parent"} password updated successfully`);
                setPasswordStudent(null);
                setNewPassword("");
              }
            });
          }, children: updateMutation.isPending ? "Updating..." : "Update Password" })
        ] })
      ] }) : null
    ] }) })
  ] });
