...
import { P as PageHeader, A as Avatar, a as AvatarFallback } from "./dashboard-shell-DwwrQh24.mjs";
import { k as getHostelStudents, m as createStudent, n as uploadStudentPhoto, B as Button, I as Input } from "./api-BdIv_iB_.mjs";
...
function StudentsPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PageHeader, { title: "Students", description: "Manage student records and profiles.", action: /* @__PURE__ */ jsxs(Dialog, { open, onOpenChange: setOpen, children: [
