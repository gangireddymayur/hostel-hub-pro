...
import { B as Button, l as login, I as Input } from "./api-BIeB_esJ.mjs";
import { C as Card, a as CardContent } from "./card-MINwparf.mjs";
import { L as Label } from "./label-aLg0ZHF3.mjs";
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-BFSonoxC.mjs";
import { i as initTheme, g as getSession, s as setSession } from "./router-DTxMphCY.mjs";
  ...
  const submit = async (event) => {
    ...
    try {
      const response = await login({
        ...
        identifier,
        password,
        hostelEmail: role === "admin" ? hostelEmail : void 0
      });
      setSession(response);
      navigate({
        ...
        /* @__PURE__ */ jsx(Card, { className: "border-border/60 shadow-lg", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
          ...
          /* @__PURE__ */ jsxs("form", { className: "mt-6 grid gap-4", onSubmit: submit, children: [
            ...
            role === "super" ? /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsx(Field, { name: "hostelEmail", label: "Hostel Email", type: "email", defaultValue: defaults.hostelEmail }),
              /* @__PURE__ */ jsx(Field, { name: "identifier", label: "Admin Email", type: "email", defaultValue: defaults.adminEmail }),
