...
import { B as Button, l as login, I as Input } from "./api-DZPXXUJT.mjs";
import { C as Card, a as CardContent } from "./card-ffd04v1y.mjs";
import { L as Label } from "./label-h62BM1Gm.mjs";
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-D2EyOrJP.mjs";
import { i as initTheme, g as getSession, s as setSession } from "./router-DLvrpDNy.mjs";
        ...
        /* @__PURE__ */ jsx(Card, { className: "border-border/60 shadow-lg", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
          ...
          /* @__PURE__ */ jsxs("form", { className: "mt-6 grid gap-4", onSubmit: submit, children: [
            ...
            role === "super" ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(Field, { name: "identifier", label: "Email", type: "email", defaultValue: "" }),
              /* @__PURE__ */ jsx(Field, { name: "password", label: "Password", type: "password", defaultValue: "" })
            ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(Field, { name: "identifier", label: "Hostel Email", type: "email", defaultValue: "" }),
              /* @__PURE__ */ jsx(Field, { name: "password", label: "Password", type: "password", defaultValue: "" })
            ] }),
