...
import { P as PageHeader } from "./dashboard-shell-DIa-7dcz.mjs";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle, d as CardDescription } from "./card-DlMLcUpm.mjs";
import { p as getHostelReports, q as getLeaveRequests, r as getHostelStudents, B as Button, I as Input } from "./api-BDk_J2ev.mjs";
import { B as Badge } from "./badge-DUzQDhd2.mjs";
import { D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-CEhvd1sn.mjs";
      ...
      /* @__PURE__ */ jsx("div", { id: "dialog-print-cards", className: "max-h-[55vh] space-y-4 overflow-y-auto p-6", children: filteredLeaves.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-12 text-center text-muted-foreground", children: [
        ...
        return /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/80 bg-card p-4 shadow-sm transition hover:border-primary/40", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 border-b border-border/60 pb-3 sm:flex-row sm:items-center sm:justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              studentPhoto ? /* @__PURE__ */ jsx("img", { src: studentPhoto, alt: "", className: "student-photo h-10 w-10 cursor-pointer rounded-full border border-primary/20 object-cover shadow-sm transition hover:scale-105", onClick: () => setZoomedPhoto({
                url: studentPhoto,
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-2 grid gap-2.5 grid-cols-1 sm:grid-cols-5", children: [
              /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border/80 bg-muted/20 p-2.5 flex flex-col justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-2 pt-1.5 border-t border-border/40", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground block truncate mb-1", children: "Student Photo" }),
                  studentPhoto ? /* @__PURE__ */ jsx("img", { src: studentPhoto, alt: "Student", className: "timeline-photo h-14 w-full cursor-pointer rounded border border-primary/30 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                    url: studentPhoto,
                    title: `Student Photo - ${leave.student?.name} (${leave.student?.student_id || leave.student_id})`
                  }) }) : /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center h-14 rounded border border-dashed border-border/60 bg-muted/30", children: /* @__PURE__ */ jsx("span", { className: "text-[9px] font-medium text-muted-foreground", children: leave.student?.name || "No Photo" }) })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: `rounded-lg border p-2.5 flex flex-col justify-between ${leave.parent_status === "APPROVED" ? "border-emerald-500/30 bg-emerald-50/50 dark:bg-emerald-950/20" : leave.parent_status === "REJECTED" ? "border-rose-500/30 bg-rose-50/50 dark:bg-rose-950/20" : "border-amber-500/30 bg-amber-50/50 dark:bg-amber-950/20"}`, children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 font-semibold text-xs text-foreground", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "mt-2 pt-1.5 border-t border-border/40", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-1.5", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground block text-center truncate mb-0.5", children: "Registered" }),
                    parentRegPhoto ? /* @__PURE__ */ jsx("img", { src: parentRegPhoto, alt: "Registered Parent", className: "timeline-photo h-14 w-full cursor-pointer rounded border border-border/80 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: parentRegPhoto,
                      title: `Registered Parent Photo - ${leave.student?.name}`
                    }) }) : /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center h-14 rounded border border-dashed border-border/60 bg-muted/20", children: /* @__PURE__ */ jsx("span", { className: "text-[8px] text-muted-foreground text-center", children: "No Reg Photo" }) })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-emerald-600 dark:text-emerald-400 block text-center truncate mb-0.5", children: "Live Action" }),
                    parentLivePhoto ? /* @__PURE__ */ jsx("img", { src: parentLivePhoto, alt: "Live Verification Selfie", className: "timeline-photo h-14 w-full cursor-pointer rounded border border-emerald-500/50 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: parentLivePhoto,
                      title: `Live Action Selfie - ${leave.student?.name}`
                    }) }) : /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center h-14 rounded border border-dashed border-border/60 bg-muted/20", children: /* @__PURE__ */ jsx("span", { className: "text-[8px] text-muted-foreground text-center", children: "No Live Selfie" }) })
                  ] })
                ] }) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: `rounded-lg border p-2.5 flex flex-col justify-between ${leave.hostel_status === "APPROVED" ? "border-emerald-500/30 bg-emerald-50/50 dark:bg-emerald-950/20" : leave.hostel_status === "REJECTED" ? "border-rose-500/30 bg-rose-50/50 dark:bg-rose-950/20" : "border-amber-500/30 bg-amber-50/50 dark:bg-amber-950/20"}`, children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 font-semibold text-xs text-foreground", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-2 pt-1.5 border-t border-border/40 space-y-1", children: [
                  leave.reviewed_by_photo ? /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground block text-center truncate mb-0.5", children: "Warden Photo" }),
                    /* @__PURE__ */ jsx("img", { src: leave.reviewed_by_photo, alt: "Warden", className: "timeline-photo h-14 w-full cursor-pointer rounded border border-border/80 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: leave.reviewed_by_photo,
                      title: `Warden Photo - ${leave.reviewed_by_name || "Hostel Warden"}`
                    }) })
                  ] }) : null,
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-[10px] text-muted-foreground", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "font-medium text-foreground truncate", children: leave.reviewed_by_name ? `Verified: ${leave.reviewed_by_name}` : "Verified by Warden" })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border/80 bg-muted/20 p-2.5 flex flex-col justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    ...
                    leave.gatePass?.out_time_actual ? /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-emerald-500/10 text-[9px] text-emerald-700 dark:text-emerald-400", children: "SCANNED OUT" }) : /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground", children: "Pending" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "mt-1.5 space-y-1 text-[11px] text-muted-foreground", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      "Time: ",
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-2 pt-1.5 border-t border-border/40 space-y-1", children: [
                  leave.gatePass?.out_guard_photo ? /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground block text-center truncate mb-0.5", children: "Guard Photo" }),
                    /* @__PURE__ */ jsx("img", { src: leave.gatePass.out_guard_photo, alt: "Guard", className: "timeline-photo h-14 w-full cursor-pointer rounded border border-border/80 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: leave.gatePass.out_guard_photo,
                      title: `Security Guard Photo - ${leave.gatePass?.out_guard_name || "Gate Exit Guard"}`
                    }) })
                  ] }) : null,
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-[10px] text-muted-foreground", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "font-medium text-foreground truncate", children: leave.gatePass?.out_guard_name ? `Guard: ${leave.gatePass.out_guard_name}` : "Gate Security Post" })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border/80 bg-muted/20 p-2.5 flex flex-col justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    ...
                    leave.gatePass?.in_time_actual ? /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-teal-500/10 text-[9px] text-teal-700 dark:text-teal-400", children: "RETURNED" }) : isOut ? /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-blue-500/10 text-[9px] text-blue-700 dark:text-blue-400", children: "OUTSIDE" }) : /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground", children: "Pending" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "mt-1.5 space-y-1 text-[11px] text-muted-foreground", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      "Time: ",
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-2 pt-1.5 border-t border-border/40 space-y-1", children: [
                  leave.gatePass?.in_guard_photo ? /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground block text-center truncate mb-0.5", children: "Guard Photo" }),
                    /* @__PURE__ */ jsx("img", { src: leave.gatePass.in_guard_photo, alt: "Guard", className: "timeline-photo h-14 w-full cursor-pointer rounded border border-border/80 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: leave.gatePass.in_guard_photo,
                      title: `Security Guard Photo - ${leave.gatePass?.in_guard_name || "Gate Return Guard"}`
                    }) })
                  ] }) : null,
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-[10px] text-muted-foreground", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "font-medium text-foreground truncate", children: leave.gatePass?.in_guard_name ? `Guard: ${leave.gatePass.in_guard_name}` : "Return Checkpoint" })
                  ] })
                ] })
              ] })
            ] })
