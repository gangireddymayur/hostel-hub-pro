...
import { Printer, ArrowRight, Calendar, FileBarChart, MapPin, Clock, ShieldCheck, User, Download, Search, CheckCircle2, XCircle, FileText } from "lucide-react";
import { P as PageHeader } from "./dashboard-shell-TJ1x0UMs.mjs";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle, d as CardDescription } from "./card-C51nzcbG.mjs";
import { p as getHostelReports, q as getLeaveRequests, r as getHostelStudents, e as getHostelStaff, B as Button, I as Input } from "./api-PCyOKVAh.mjs";
import { B as Badge } from "./badge-D0ifL_wx.mjs";
import { D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-4BmU_zyP.mjs";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Dialog, { open: modalOpen, onOpenChange: setModalOpen, children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-h-[92vh] max-w-5xl overflow-hidden p-0 sm:rounded-xl", children: [
      ...
      /* @__PURE__ */ jsx("div", { id: "dialog-print-cards", className: "max-h-[55vh] space-y-4 overflow-y-auto p-6", children: filteredLeaves.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-12 text-center text-muted-foreground", children: [
        ...
        const isOut = leave.gatePass?.status === "OUT" || leave.gatePass?.out_time_actual && !leave.gatePass?.in_time_actual;
        const isReturned = Boolean(leave.gatePass?.in_time_actual || leave.gatePass?.status === "RETURNED" || leave.final_status === "RETURNED");
        const parentLivePhoto = leave.parent_approval_photo;
        const parentRegPhoto = leave.student?.parent_profile_photo || leave.parent_profile_photo;
        const studentPhoto = leave.student?.profile_photo;
        const studentHostelId = leave.student?.hostel_id || leave.hostel_id;
        const wardenPhoto = leave.reviewed_by_photo || leave.warden_photo || allStaff.find((s) => s.hostel_id === studentHostelId && ["HOSTEL_ADMIN", "HOSTEL_STAFF", "CARETAKER"].includes(s.role) && s.profile_photo)?.profile_photo || allStaff.find((s) => ["HOSTEL_ADMIN", "HOSTEL_STAFF", "CARETAKER"].includes(s.role) && s.profile_photo)?.profile_photo;
        const wardenName = leave.reviewed_by_name || allStaff.find((s) => s.hostel_id === studentHostelId && ["HOSTEL_ADMIN", "HOSTEL_STAFF", "CARETAKER"].includes(s.role))?.name || "Hostel Warden";
        const guardExitPhoto = leave.gatePass?.out_guard_photo || leave.gatePass?.guard_photo || allStaff.find((s) => s.hostel_id === studentHostelId && s.role === "SECURITY_GUARD" && s.profile_photo)?.profile_photo || allStaff.find((s) => s.role === "SECURITY_GUARD" && s.profile_photo)?.profile_photo;
        const guardExitName = leave.gatePass?.out_guard_name || allStaff.find((s) => s.hostel_id === studentHostelId && s.role === "SECURITY_GUARD")?.name || "Security Guard";
        const guardReturnPhoto = leave.gatePass?.in_guard_photo || allStaff.find((s) => s.hostel_id === studentHostelId && s.role === "SECURITY_GUARD" && s.profile_photo)?.profile_photo || allStaff.find((s) => s.role === "SECURITY_GUARD" && s.profile_photo)?.profile_photo;
        const guardReturnName = leave.gatePass?.in_guard_name || allStaff.find((s) => s.hostel_id === studentHostelId && s.role === "SECURITY_GUARD")?.name || "Security Guard";
        return /* @__PURE__ */ jsxs("div", { className: "audit-request-card rounded-xl border border-border/80 bg-card p-4 sm:p-5 shadow-sm transition hover:border-primary/40", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 border-b border-border/60 pb-3 sm:flex-row sm:items-center sm:justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              studentPhoto ? /* @__PURE__ */ jsx("img", { src: studentPhoto, alt: "", className: "student-photo h-11 w-11 cursor-pointer rounded-full border border-primary/30 object-cover shadow-sm transition hover:scale-105", onClick: () => setZoomedPhoto({
                url: studentPhoto,
                title: `Student Photo - ${leave.student?.name}`
              }) }) : /* @__PURE__ */ jsx("div", { className: "flex h-11 w-11 items-center justify-center rounded-full bg-primary/10 font-bold text-primary border border-primary/20", children: leave.student?.name?.slice(0, 2).toUpperCase() || "ST" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                  /* @__PURE__ */ jsx("span", { className: "font-bold text-foreground text-sm sm:text-base", children: leave.student?.name || "Student" }),
                  /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "font-mono text-xs font-semibold px-2 py-0.5", children: leave.student?.student_id || leave.student_id }),
                  /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: "text-xs px-2 py-0.5", children: formatRoom(leave.student?.room_number) }),
                  /* @__PURE__ */ jsxs(Badge, { variant: "outline", className: "text-xs bg-muted/60 px-2 py-0.5", children: [
                    "Request #",
                    idx + 1
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "text-xs text-muted-foreground mt-0.5", children: [
                  "Hostel: ",
                  /* @__PURE__ */ jsx("strong", { className: "text-foreground/80", children: leave.student?.hostel_name || "Primary" }),
                  " | Mobile: ",
                  /* @__PURE__ */ jsx("strong", { className: "text-foreground/80", children: leave.student?.mobile || "—" }),
                  " | Parent: ",
                  /* @__PURE__ */ jsx("strong", { className: "text-foreground/80", children: leave.student?.parent_mobile || "—" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: isReturned ? /* @__PURE__ */ jsx(Badge, { className: "bg-teal-600 text-white font-bold px-3 py-1 text-xs", children: "RETURNED" }) : isOut ? /* @__PURE__ */ jsx(Badge, { className: "bg-blue-600 text-white font-bold px-3 py-1 text-xs animate-pulse", children: "CURRENTLY OUT" }) : /* @__PURE__ */ jsx(Badge, { className: `font-semibold px-3 py-1 text-xs ${leave.final_status === "APPROVED" ? "bg-emerald-500/15 text-emerald-700 hover:bg-emerald-500/20" : leave.final_status === "REJECTED" ? "bg-rose-500/15 text-rose-700 hover:bg-rose-500/20" : "bg-amber-500/15 text-amber-700 hover:bg-amber-500/20"}`, children: leave.final_status }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-3 grid gap-2.5 sm:grid-cols-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-muted/50 p-2.5 sm:col-span-2 border border-border/40", children: [
              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground", children: "Reason / Destination" }),
              /* @__PURE__ */ jsx("p", { className: "mt-0.5 text-xs font-semibold text-foreground", children: leave.reason || "No reason specified" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-muted/50 p-2.5 border border-border/40", children: [
              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground", children: "Scheduled Window" }),
              /* @__PURE__ */ jsxs("p", { className: "mt-0.5 text-xs font-semibold text-foreground", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold uppercase tracking-wider text-muted-foreground", children: "Movement & Verification Audit Trail" }),
            /* @__PURE__ */ jsxs("div", { className: "audit-steps-grid mt-2.5 grid gap-2.5 grid-cols-1 sm:grid-cols-5", children: [
              /* @__PURE__ */ jsxs("div", { className: "audit-step-col rounded-lg border border-border/80 bg-muted/20 p-2.5 flex flex-col justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 font-bold text-xs text-foreground", children: [
                    /* @__PURE__ */ jsx("span", { className: "flex h-4 w-4 items-center justify-center rounded-full bg-primary text-[9px] text-primary-foreground font-bold", children: "1" }),
                    "Student Request"
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "mt-1.5 space-y-1 text-xs text-muted-foreground", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      "Submitted: ",
                    ...
                    leave.student_lat != null && leave.student_lng != null ? /* @__PURE__ */ jsxs("a", { href: `https://maps.google.com/?q=${leave.student_lat},${leave.student_lng}`, target: "_blank", rel: "noreferrer", className: "flex items-center gap-1 text-[11px] font-medium text-primary hover:underline", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-2.5 pt-2 border-t border-border/40", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-muted-foreground block truncate mb-1", children: "Student Photo" }),
                  studentPhoto ? /* @__PURE__ */ jsx("img", { src: studentPhoto, alt: "Student", className: "timeline-photo h-20 w-full cursor-pointer rounded-md border border-primary/30 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                    url: studentPhoto,
                    title: `Student Photo - ${leave.student?.name} (${leave.student?.student_id || leave.student_id})`
                  }) }) : /* @__PURE__ */ jsx("div", { className: "photo-placeholder flex flex-col items-center justify-center h-20 rounded-md border border-dashed border-border/60 bg-muted/30", children: /* @__PURE__ */ jsx("span", { className: "text-[10px] font-medium text-muted-foreground", children: leave.student?.name || "No Photo" }) })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: `audit-step-col rounded-lg border p-2.5 flex flex-col justify-between ${leave.parent_status === "APPROVED" ? "border-emerald-500/30 bg-emerald-50/50 dark:bg-emerald-950/20" : leave.parent_status === "REJECTED" ? "border-rose-500/30 bg-rose-50/50 dark:bg-rose-950/20" : "border-amber-500/30 bg-amber-50/50 dark:bg-amber-950/20"}`, children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 font-bold text-xs text-foreground", children: [
                      /* @__PURE__ */ jsx("span", { className: "flex h-4 w-4 items-center justify-center rounded-full bg-primary text-[9px] text-primary-foreground font-bold", children: "2" }),
                      "Parent Verification"
                    ] }),
                    /* @__PURE__ */ jsx("span", { className: `text-[10px] font-bold ${leave.parent_status === "APPROVED" ? "text-emerald-600 dark:text-emerald-400" : leave.parent_status === "REJECTED" ? "text-rose-600 dark:text-rose-400" : "text-amber-600 dark:text-amber-400"}`, children: leave.parent_status || "PENDING" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "mt-1.5 space-y-1 text-xs text-muted-foreground", children: [
                    leave.parent_lat != null && leave.parent_lng != null && /* @__PURE__ */ jsxs("a", { href: `https://maps.google.com/?q=${leave.parent_lat},${leave.parent_lng}`, target: "_blank", rel: "noreferrer", className: "flex items-center gap-1 text-[11px] font-medium text-primary hover:underline", children: [
                      /* @__PURE__ */ jsx(MapPin, { className: "h-3 w-3 shrink-0" }),
                      "Parent GPS"
                    ] }),
                    leave.parent_reject_reason && /* @__PURE__ */ jsxs("p", { className: "text-[10px] font-medium text-rose-600", children: [
                      "Reject: ",
                      leave.parent_reject_reason
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "mt-2.5 pt-2 border-t border-border/40", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-1.5", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground block text-center truncate mb-1", children: "Registered" }),
                    parentRegPhoto ? /* @__PURE__ */ jsx("img", { src: parentRegPhoto, alt: "Registered Parent", className: "timeline-photo h-20 w-full cursor-pointer rounded-md border border-border/80 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: parentRegPhoto,
                      title: `Registered Parent Photo - ${leave.student?.name}`
                    }) }) : /* @__PURE__ */ jsx("div", { className: "photo-placeholder flex flex-col items-center justify-center h-20 rounded-md border border-dashed border-border/60 bg-muted/20", children: /* @__PURE__ */ jsx("span", { className: "text-[8px] text-muted-foreground text-center", children: "No Reg Photo" }) })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-emerald-600 dark:text-emerald-400 block text-center truncate mb-1", children: "Live Action" }),
                    parentLivePhoto ? /* @__PURE__ */ jsx("img", { src: parentLivePhoto, alt: "Live Verification Selfie", className: "timeline-photo h-20 w-full cursor-pointer rounded-md border border-emerald-500/50 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: parentLivePhoto,
                      title: `Live Action Selfie - ${leave.student?.name}`
                    }) }) : /* @__PURE__ */ jsx("div", { className: "photo-placeholder flex flex-col items-center justify-center h-20 rounded-md border border-dashed border-border/60 bg-muted/20", children: /* @__PURE__ */ jsx("span", { className: "text-[8px] text-muted-foreground text-center", children: "No Live Selfie" }) })
                  ] })
                ] }) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: `audit-step-col rounded-lg border p-2.5 flex flex-col justify-between ${leave.hostel_status === "APPROVED" ? "border-emerald-500/30 bg-emerald-50/50 dark:bg-emerald-950/20" : leave.hostel_status === "REJECTED" ? "border-rose-500/30 bg-rose-50/50 dark:bg-rose-950/20" : "border-amber-500/30 bg-amber-50/50 dark:bg-amber-950/20"}`, children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 font-bold text-xs text-foreground", children: [
                      /* @__PURE__ */ jsx("span", { className: "flex h-4 w-4 items-center justify-center rounded-full bg-primary text-[9px] text-primary-foreground font-bold", children: "3" }),
                      "Warden Review"
                    ] }),
                    /* @__PURE__ */ jsx("span", { className: `text-[10px] font-bold ${leave.hostel_status === "APPROVED" ? "text-emerald-600 dark:text-emerald-400" : leave.hostel_status === "REJECTED" ? "text-rose-600 dark:text-rose-400" : "text-amber-600 dark:text-amber-400"}`, children: leave.hostel_status || "PENDING" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "mt-1.5 space-y-1 text-xs text-muted-foreground", children: [
                    leave.hostel_lat != null && /* @__PURE__ */ jsxs("a", { href: `https://maps.google.com/?q=${leave.hostel_lat},${leave.hostel_lng}`, target: "_blank", rel: "noreferrer", className: "flex items-center gap-1 text-[11px] font-medium text-primary hover:underline", children: [
                      /* @__PURE__ */ jsx(MapPin, { className: "h-3 w-3 shrink-0" }),
                      " Warden GPS"
                    ] }),
                    leave.note && /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-foreground font-semibold", children: [
                      "Note: ",
                      leave.note
                    ] }),
                    leave.hostel_reject_reason && /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-rose-600 font-semibold", children: [
                      "Reject: ",
                      leave.hostel_reject_reason
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "mt-2.5 pt-2 border-t border-border/40 space-y-1.5", children: [
                  wardenPhoto ? /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground block text-center truncate mb-1", children: "Warden Photo" }),
                    /* @__PURE__ */ jsx("img", { src: wardenPhoto, alt: "Warden", className: "timeline-photo h-20 w-full cursor-pointer rounded-md border border-border/80 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: wardenPhoto,
                      title: `Warden Photo - ${wardenName}`
                    }) })
                  ] }) : /* @__PURE__ */ jsx("div", { className: "photo-placeholder flex flex-col items-center justify-center h-20 rounded-md border border-dashed border-border/60 bg-muted/20", children: /* @__PURE__ */ jsx("span", { className: "text-[8px] text-muted-foreground text-center", children: "No Photo Uploaded" }) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-[11px] text-muted-foreground", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground truncate", children: `Verified: ${wardenName}` })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "audit-step-col rounded-lg border border-border/80 bg-muted/20 p-2.5 flex flex-col justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 font-bold text-xs text-foreground", children: [
                      /* @__PURE__ */ jsx("span", { className: "flex h-4 w-4 items-center justify-center rounded-full bg-primary text-[9px] text-primary-foreground font-bold", children: "4" }),
                      "Gate Exit"
                    ] }),
                    leave.gatePass?.out_time_actual ? /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-emerald-500/10 text-[9px] font-bold text-emerald-700 dark:text-emerald-400", children: "SCANNED OUT" }) : /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground", children: "Pending" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "mt-1.5 space-y-1 text-xs text-muted-foreground", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      "Time: ",
                    ...
                    leave.gatePass?.out_guard_lat != null && /* @__PURE__ */ jsxs("a", { href: `https://maps.google.com/?q=${leave.gatePass.out_guard_lat},${leave.gatePass.out_guard_lng}`, target: "_blank", rel: "noreferrer", className: "flex items-center gap-1 text-[11px] font-medium text-primary hover:underline", children: [
                      /* @__PURE__ */ jsx(MapPin, { className: "h-3 w-3 shrink-0" }),
                      " Gate GPS"
                    ] })
                  ] })
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-2.5 pt-2 border-t border-border/40 space-y-1.5", children: [
                  guardExitPhoto ? /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground block text-center truncate mb-1", children: "Guard Photo" }),
                    /* @__PURE__ */ jsx("img", { src: guardExitPhoto, alt: "Guard", className: "timeline-photo h-20 w-full cursor-pointer rounded-md border border-border/80 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: guardExitPhoto,
                      title: `Security Guard Photo - ${guardExitName}`
                    }) })
                  ] }) : /* @__PURE__ */ jsx("div", { className: "photo-placeholder flex flex-col items-center justify-center h-20 rounded-md border border-dashed border-border/60 bg-muted/20", children: /* @__PURE__ */ jsx("span", { className: "text-[8px] text-muted-foreground text-center", children: "No Photo Uploaded" }) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-[11px] text-muted-foreground", children: [
                    /* @__PURE__ */ jsx("div", { className: "flex h-4 w-4 items-center justify-center rounded-full bg-emerald-500/20 text-emerald-600 shrink-0", children: /* @__PURE__ */ jsx(ShieldCheck, { className: "h-2.5 w-2.5" }) }),
                    /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground truncate", children: `Guard: ${guardExitName}` })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "audit-step-col rounded-lg border border-border/80 bg-muted/20 p-2.5 flex flex-col justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 font-bold text-xs text-foreground", children: [
                      /* @__PURE__ */ jsx("span", { className: "flex h-4 w-4 items-center justify-center rounded-full bg-primary text-[9px] text-primary-foreground font-bold", children: "5" }),
                      "Gate Return"
                    ] }),
                    leave.gatePass?.in_time_actual ? /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-teal-500/10 text-[9px] font-bold text-teal-700 dark:text-teal-400", children: "RETURNED" }) : isOut ? /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-blue-500/10 text-[9px] font-bold text-blue-700 dark:text-blue-400", children: "OUTSIDE" }) : /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground", children: "Pending" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "mt-1.5 space-y-1 text-xs text-muted-foreground", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      "Time: ",
                    ...
                    leave.gatePass?.in_guard_lat != null && /* @__PURE__ */ jsxs("a", { href: `https://maps.google.com/?q=${leave.gatePass.in_guard_lat},${leave.gatePass.in_guard_lng}`, target: "_blank", rel: "noreferrer", className: "flex items-center gap-1 text-[11px] font-medium text-primary hover:underline", children: [
                      /* @__PURE__ */ jsx(MapPin, { className: "h-3 w-3 shrink-0" }),
                      " Return GPS"
                    ] })
                  ] })
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-2.5 pt-2 border-t border-border/40 space-y-1.5", children: [
                  guardReturnPhoto ? /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground block text-center truncate mb-1", children: "Guard Photo" }),
                    /* @__PURE__ */ jsx("img", { src: guardReturnPhoto, alt: "Guard", className: "timeline-photo h-20 w-full cursor-pointer rounded-md border border-border/80 object-cover shadow-sm transition hover:opacity-90 hover:scale-[1.02]", onClick: () => setZoomedPhoto({
                      url: guardReturnPhoto,
                      title: `Security Guard Photo - ${guardReturnName}`
                    }) })
                  ] }) : /* @__PURE__ */ jsx("div", { className: "photo-placeholder flex flex-col items-center justify-center h-20 rounded-md border border-dashed border-border/60 bg-muted/20", children: /* @__PURE__ */ jsx("span", { className: "text-[8px] text-muted-foreground text-center", children: "No Photo Uploaded" }) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-[11px] text-muted-foreground", children: [
                    /* @__PURE__ */ jsx("div", { className: "flex h-4 w-4 items-center justify-center rounded-full bg-teal-500/20 text-teal-600 shrink-0", children: /* @__PURE__ */ jsx(ShieldCheck, { className: "h-2.5 w-2.5" }) }),
                    /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground truncate", children: `Guard: ${guardReturnName}` })
                  ] })
                ] })
              ] })
            ] })
      ...
      /* @__PURE__ */ jsx(DialogFooter, { className: "border-t bg-muted/30 px-6 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex w-full items-center justify-between", children: [
        /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground", children: "GATEX Automated Audit & Movement Logging System" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
