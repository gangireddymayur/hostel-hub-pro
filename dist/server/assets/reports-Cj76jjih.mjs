...
import { P as PageHeader } from "./dashboard-shell-MuaKKX9k.mjs";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle, d as CardDescription } from "./card-DK6PuUd1.mjs";
import { m as getHostelReports, n as getLeaveRequests, o as getHostelStudents, B as Button, I as Input } from "./api-Bf0rDCn5.mjs";
import { B as Badge } from "./badge-DL6cEHXE.mjs";
import { D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-DIs8k9iq.mjs";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { id: "printable-audit-report", className: "hidden font-sans text-black", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-4 space-y-4", children: filteredLeaves.map((leave, index) => {
        ...
        const isOut = leave.gatePass?.status === "OUT" || leave.gatePass?.out_time_actual && !leave.gatePass?.in_time_actual;
        const isReturned = Boolean(leave.gatePass?.in_time_actual || leave.gatePass?.status === "RETURNED" || leave.final_status === "RETURNED");
        return /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-gray-400 p-3 page-break-avoid text-xs bg-white", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-gray-300 pb-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxs("span", { className: "rounded bg-black text-white px-2 py-0.5 font-bold text-[10px]", children: [
                "REQUEST #",
                index + 1,
                " OF ",
                filteredLeaves.length
              ] }),
              studentPhoto && /* @__PURE__ */ jsx("img", { src: studentPhoto, alt: "", className: "h-7 w-7 rounded-full border object-cover" }),
              /* @__PURE__ */ jsx("span", { className: "font-bold text-sm text-gray-900", children: leave.student?.name || "Student" }),
              /* @__PURE__ */ jsxs("span", { className: "font-mono text-gray-700", children: [
                "(",
                leave.student?.student_id || leave.student_id,
                ")"
              ] }),
              /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: formatRoom(leave.student?.room_number) })
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-2 grid grid-cols-3 gap-2 bg-gray-50 p-2 rounded border border-gray-200", children: [
            /* @__PURE__ */ jsxs("div", { className: "col-span-2", children: [
              /* @__PURE__ */ jsxs("p", { children: [
                /* @__PURE__ */ jsx("strong", { children: "Reason / Destination:" }),
                " ",
                leave.reason || "N/A"
              ] }),
              /* @__PURE__ */ jsxs("p", { children: [
                /* @__PURE__ */ jsx("strong", { children: "Scheduled Window:" }),
                " ",
                leave.from_date,
                " ➔ ",
                leave.to_date
          ...
          /* @__PURE__ */ jsxs("table", { className: "mt-2 w-full border-collapse border border-gray-300 text-[10px]", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-gray-100 font-bold", children: [
              /* @__PURE__ */ jsx("th", { className: "border border-gray-300 p-1 text-left", children: "1. Student Request" }),
              /* @__PURE__ */ jsx("th", { className: "border border-gray-300 p-1 text-left", children: "2. Parent Verification" }),
              /* @__PURE__ */ jsx("th", { className: "border border-gray-300 p-1 text-left", children: "3. Warden Approval" }),
              /* @__PURE__ */ jsx("th", { className: "border border-gray-300 p-1 text-left", children: "4. Gate Exit" }),
              /* @__PURE__ */ jsx("th", { className: "border border-gray-300 p-1 text-left", children: "5. Gate Return" })
            ] }) }),
            /* @__PURE__ */ jsx("tbody", { children: /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsxs("td", { className: "border border-gray-300 p-1.5 align-top", children: [
                /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx("strong", { children: "Submitted:" }) }),
                /* @__PURE__ */ jsx("p", { children: leave.created_at ? new Date(leave.created_at).toLocaleString() : "—" }),
                leave.student_lat != null && /* @__PURE__ */ jsxs("p", { className: "text-gray-600 mt-1", children: [
                  "GPS: ",
              ...
              /* @__PURE__ */ jsxs("td", { className: "border border-gray-300 p-1.5 align-top", children: [
                ...
                parentPhoto ? /* @__PURE__ */ jsxs("div", { className: "mt-1", children: [
                  /* @__PURE__ */ jsx("p", { className: "font-semibold text-[9px] text-gray-700", children: "Live Photo:" }),
                  /* @__PURE__ */ jsx("img", { src: parentPhoto, alt: "Parent live selfie", className: "h-14 w-14 rounded border border-gray-400 object-cover mt-0.5" })
                ] }) : /* @__PURE__ */ jsx("p", { className: "italic text-gray-500 mt-1", children: "No photo" })
              ] }),
              /* @__PURE__ */ jsxs("td", { className: "border border-gray-300 p-1.5 align-top", children: [
                /* @__PURE__ */ jsxs("p", { children: [
                  /* @__PURE__ */ jsx("strong", { children: "Status:" }),
                ...
                leave.hostel_lat != null && /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Warden GPS verified" }),
                leave.note && /* @__PURE__ */ jsxs("p", { className: "italic mt-1 text-gray-700", children: [
                  "Note: ",
                  String(leave.note)
                ] })
              ] }),
              /* @__PURE__ */ jsxs("td", { className: "border border-gray-300 p-1.5 align-top", children: [
                ...
                /* @__PURE__ */ jsx("p", { children: leave.gatePass?.out_time_actual ? new Date(leave.gatePass.out_time_actual).toLocaleTimeString() : "—" }),
              ...
              /* @__PURE__ */ jsxs("td", { className: "border border-gray-300 p-1.5 align-top", children: [
                /* @__PURE__ */ jsxs("p", { children: [
                  /* @__PURE__ */ jsx("strong", { children: "Status:" }),
                  " ",
                  leave.gatePass?.in_time_actual ? "Returned" : isOut ? "Currently Out" : "Pending"
                ] }),
                /* @__PURE__ */ jsx("p", { children: leave.gatePass?.in_time_actual ? new Date(leave.gatePass.in_time_actual).toLocaleTimeString() : "—" })
              ] })
            ] }) })
          ] })
        ] }, leave.id || index);
