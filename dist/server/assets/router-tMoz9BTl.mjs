...
const appCss = "/assets/styles-BGk7KPw1.css";
...
const Route$l = createRootRouteWithContext()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "GATEX" },
      { name: "description", content: "Gate & Movement Permission Management System" },
      { name: "author", content: "GATEX" },
      { property: "og:title", content: "GATEX" },
      { property: "og:description", content: "Gate & Movement Permission Management System" },
...
const $$splitComponentImporter$h = () => import("./super-wQQMPwRI.mjs");
const Route$k = createFileRoute("/super")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./login-Br3ez0gz.mjs");
...
const $$splitComponentImporter$f = () => import("./admin-C5vyP1M8.mjs");
...
const $$splitComponentImporter$e = () => import("./settings-BJjYeAXV.mjs");
const Route$e = createFileRoute("/super/settings")({
  head: () => ({
    meta: [{
      title: "Settings · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./hostels-D19UeiRx.mjs");
const Route$d = createFileRoute("/super/hostels")({
  head: () => ({
    meta: [{
      title: "Hostel Management · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./dashboard-DJ9AlgeJ.mjs");
const Route$c = createFileRoute("/super/dashboard")({
  head: () => ({
    meta: [{
      title: "Super Admin Dashboard · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./analytics-CcWe2MOI.mjs");
const Route$b = createFileRoute("/super/analytics")({
  head: () => ({
    meta: [{
      title: "Analytics · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./staff-CEV-e9EH.mjs");
...
const $$splitComponentImporter$9 = () => import("./settings-DZmsa7KI.mjs");
...
const $$splitComponentImporter$8 = () => import("./reports-CJe107LN.mjs");
...
const $$splitComponentImporter$7 = () => import("./leaves-CLdytxnJ.mjs");
const Route$7 = createFileRoute("/admin/leaves")({
  head: () => ({
    meta: [{
      title: "Permission Requests · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./hostels-BuXO_cLs.mjs");
...
const $$splitComponentImporter$5 = () => import("./guards-D7W9Jt1t.mjs");
const Route$5 = createFileRoute("/admin/guards")({
  head: () => ({
    meta: [{
      title: "Security Guards · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./dashboard-CuC7cxGL.mjs");
const Route$4 = createFileRoute("/admin/dashboard")({
  head: () => ({
    meta: [{
      title: "Dashboard · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./index-Do9YdAUM.mjs");
const Route$3 = createFileRoute("/admin/students/")({
  head: () => ({
    meta: [{
      title: "Students · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./returned-BE7knU8p.mjs");
const Route$2 = createFileRoute("/admin/tracking/returned")({
  head: () => ({
    meta: [{
      title: "Students Returned · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./outside-BoI9RsC7.mjs");
const Route$1 = createFileRoute("/admin/tracking/outside")({
  head: () => ({
    meta: [{
      title: "Students Outside · GATEX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./import-BbF5hIcS.mjs");
const Route = createFileRoute("/admin/students/import")({
  head: () => ({
    meta: [{
      title: "Import & Bulk Photos · GATEX"
    }]
  }),
