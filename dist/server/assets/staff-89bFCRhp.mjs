...
import { P as PageHeader, A as Avatar, a as AvatarImage, b as AvatarFallback } from "./dashboard-shell-63jKkWHh.mjs";
import { e as getHostelStaff, f as getHostels, h as uploadStaffPhoto, i as createStaff, j as updateStaff, k as deleteStaff, B as Button, I as Input } from "./api-C_mQxO-z.mjs";
import { C as Card, a as CardContent } from "./card-DZ-ChVhm.mjs";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-HUuOunR0.mjs";
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, f as DialogFooter } from "./dialog-BQoYq0Xs.mjs";
import { L as Label } from "./label-2jSTO_qW.mjs";
    ...
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "p-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-lg border border-border/60", children: /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: filtered.map((staff) => /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { children: staff.role === "HOSTEL_ADMIN" || staff.hostel_id?.endsWith("_ALL") ? /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground italic", children: "All hostels" }) : staff.hostel_name || "N/A" }),
