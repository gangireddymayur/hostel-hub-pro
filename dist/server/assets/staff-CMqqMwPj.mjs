...
import { e as getHostelStaff, f as getHostels, h as uploadStaffPhoto, i as createStaff, j as updateStaff, k as deleteStaff, B as Button, I as Input } from "./api-S_7J8C7a.mjs";
...
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, f as DialogFooter } from "./dialog-CZtagB8G.mjs";
      ...
      /* @__PURE__ */ jsxs(DialogContent, { children: [
        ...
        /* @__PURE__ */ jsxs("form", { className: "grid gap-4", onSubmit: (event) => {
          ...
          /* @__PURE__ */ jsxs(DialogFooter, { className: "flex flex-col-reverse sm:flex-row sm:justify-between items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx(Button, { type: "submit", children: editingStaff ? "Save changes" : "Save" })
          ] })
