...
import { P as PageHeader, A as Avatar, a as AvatarFallback } from "./dashboard-shell-Ba0azbrf.mjs";
import { d as getHostelStaff, e as getHostels, f as createStaff, h as updateStaff, B as Button, I as Input } from "./api-C3F3eXdT.mjs";
...
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, f as DialogFooter } from "./dialog-DkIUHvq_.mjs";
    ...
    /* @__PURE__ */ jsx(PageHeader, { title: "Staff", description: "Manage hostel staff members.", action: /* @__PURE__ */ jsxs(Dialog, { open, onOpenChange: (val) => {
      ...
      /* @__PURE__ */ jsxs(DialogContent, { children: [
        ...
        /* @__PURE__ */ jsxs("form", { className: "grid gap-4", onSubmit: (event) => {
          ...
          !editingStaff && /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "hostel_select", children: "Hostel (Optional)" }),
            /* @__PURE__ */ jsxs("select", { id: "hostel_select", value: selectedHostel, onChange: (e) => setSelectedHostel(e.target.value), className: "h-10 rounded-md border border-input bg-background px-3 py-2 text-sm", children: [
