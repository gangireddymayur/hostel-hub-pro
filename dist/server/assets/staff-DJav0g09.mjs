...
import { e as getHostelStaff, f as getHostels, h as uploadStaffPhoto, i as createStaff, j as updateStaff, k as deleteStaff, B as Button, I as Input } from "./api-BDk_J2ev.mjs";
...
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, f as DialogFooter } from "./dialog-CEhvd1sn.mjs";
        ...
        /* @__PURE__ */ jsxs("form", { className: "grid gap-4", onSubmit: (event) => {
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxs("select", { id: "role", name: "role", value: selectedRole, onChange: (e) => {
              ...
              /* @__PURE__ */ jsx("option", { value: "HOSTEL_STAFF", children: "Hostel Staff / Warden" }),
              /* @__PURE__ */ jsx("option", { value: "CARETAKER", children: "Caretaker" }),
          ...
          showHostelPicker && /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "hostel_select", children: "Hostel Access" }),
            /* @__PURE__ */ jsxs("select", { id: "hostel_select", value: selectedHostel, onChange: (e) => setSelectedHostel(e.target.value), required: true, className: "h-10 rounded-md border border-input bg-background px-3 py-2 text-sm", children: [
              ...
              hostels.length > 0 && /* @__PURE__ */ jsx("option", { value: `${hostels[0]?.id}_ALL`, children: "🏢 All Hostels (all branches)" }),
              hostels.map((hostel) => /* @__PURE__ */ jsx("option", { value: hostel.id, children: hostel.hostel_name }, hostel.id))
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: selectedHostel?.endsWith("_ALL") ? "⚠️ All Hostels: this staff member can see students from ALL branches." : "You can reassign this staff member to any hostel you manage." })
          ] }),
    ...
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "p-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-4 flex flex-wrap items-center gap-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative max-w-sm flex-1", children: [
          ...
          /* @__PURE__ */ jsx(Input, { placeholder: "Search staff by name, email…", value: q, onChange: (e) => {
            setQ(e.target.value);
            setPage(1);
          }, className: "pl-9" })
        ] }),
        /* @__PURE__ */ jsxs("select", { value: roleFilter, onChange: (e) => {
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-lg border border-border/60 bg-card", children: /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: paginated.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 5, className: "text-center py-6 text-muted-foreground font-medium", children: "No staff records found." }) }) : paginated.map((staff) => /* @__PURE__ */ jsxs(TableRow, { children: [
          /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxs(Avatar, { className: "h-8 w-8", children: [
              ...
              /* @__PURE__ */ jsx(AvatarFallback, { className: "bg-accent text-accent-foreground text-xs font-semibold", children: staff.name.split(" ").map((part) => part[0]).slice(0, 2).join("") })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: staff.name })
          ] }) }),
          /* @__PURE__ */ jsx(TableCell, { className: "font-medium", children: staff.role.toLowerCase().replaceAll("_", " ") }),
          /* @__PURE__ */ jsx(TableCell, { className: "font-medium", children: staff.role === "HOSTEL_ADMIN" || staff.hostel_id?.endsWith("_ALL") ? /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground italic", children: "All hostels" }) : staff.hostel_name || "N/A" }),
          /* @__PURE__ */ jsx(TableCell, { className: "text-xs font-medium text-muted-foreground", children: staff.email }),
