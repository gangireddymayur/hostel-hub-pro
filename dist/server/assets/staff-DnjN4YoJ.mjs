...
import { P as PageHeader, A as Avatar, a as AvatarImage, b as AvatarFallback } from "./dashboard-shell-CaBrwoYn.mjs";
import { e as getHostelStaff, f as getHostels, h as uploadStaffPhoto, i as createStaff, j as updateStaff, k as deleteStaff, B as Button, I as Input } from "./api-CGMwTg9j.mjs";
import { C as Card, a as CardContent } from "./card-DsMWruFG.mjs";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-B5wd6MWu.mjs";
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, f as DialogFooter } from "./dialog-CMaqJ36G.mjs";
import { L as Label } from "./label-Caw72Rtw.mjs";
        ...
        /* @__PURE__ */ jsxs("form", { className: "grid gap-4", onSubmit: (event) => {
          ...
          showHostelPicker && /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxs("select", { id: "hostel_select", value: selectedHostel, onChange: (e) => setSelectedHostel(e.target.value), required: true, className: "h-10 rounded-md border border-input bg-background px-3 py-2 text-sm", children: [
              ...
              hostels.length > 0 && /* @__PURE__ */ jsx("option", { value: hostels[0]?.id ?? "", children: "🏢 All Hostels (all branches)" }),
              hostels.map((hostel) => /* @__PURE__ */ jsx("option", { value: hostel.id, children: hostel.hostel_name }, hostel.id))
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: selectedHostel === (hostels[0]?.id ?? "") && hostels.length > 1 ? "⚠️ All Hostels: this staff member can see students from ALL branches." : "You can reassign this staff member to any hostel you manage." })
          ] }),
    ...
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "p-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-lg border border-border/60", children: /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: filtered.map((staff) => /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { children: staff.role === "HOSTEL_ADMIN" || hostels.length > 0 && staff.hostel_id === hostels[0]?.id && hostels.length > 1 ? /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground italic", children: "All hostels" }) : staff.hostel_name || "N/A" }),
