...
import { a as getSuperHostels, b as createHostel, u as updateHostel, d as setHostelStatus, B as Button, I as Input } from "./api-Do8Q2seI.js";
import { C as Card, a as CardContent } from "./card-B2FR12yV.js";
import { B as Badge } from "./badge-CQuJCU8X.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-BDhOc3Ur.js";
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-fGmQjBIE.js";
import { L as Label } from "./label-BvySxiqo.js";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PageHeader, { title: "Hostel management", description: "Create, edit and manage all hostels on the platform.", action: /* @__PURE__ */ jsxs(Dialog, { open, onOpenChange: setOpen, children: [
      ...
      /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-2xl", children: [
        ...
        /* @__PURE__ */ jsx(HostelForm, { isCreate: true, onSubmit: (payload) => createMutation.mutate(payload), submitLabel: createMutation.isPending ? "Creating..." : "Create Hostel", onCancel: () => setOpen(false) })
      ] })
    ] }) }),
